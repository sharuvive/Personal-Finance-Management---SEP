...
public class DataBaseHelper extends SQLiteOpenHelper
{
    ...
    public ArrayList<category> getCategories1() {
        ...
        SQLiteDatabase db = getReadableDatabase();
        Cursor c = db.query(DataBaseHelper.categoryIncone_table_name, null, null, null, null, null, null); //cursor contain collection of data for particula query
        while (c.moveToNext()) {
            category cat = new category(c.getInt(0), c.getString(1)); //get the name and id
    ...
    public ArrayList<categoryIncone> getIncomeCategories() {
        ...
        SQLiteDatabase db = getReadableDatabase();
        Cursor c = db.query(DataBaseHelper.categoryIncone_table_name, null, null, null,
    ...
    public ArrayList<SubCategoryExpense> getSubCategoriesExpense() {
        ...
        SQLiteDatabase db = getReadableDatabase();
        Cursor c = db.query(DataBaseHelper.SUBCATEGORY_TABLE_NAME, null, null, null,
                null, null, null); //cursor contain collection of data for particula query
        while (c.moveToNext()) {
    ...
    public ArrayList<SubCategory> getSubCategories(String category){
        ...
        SQLiteDatabase db = getReadableDatabase();
        Cursor c = db.rawQuery("select *  from " + SUBCATEGORY_TABLE_NAME + " where " + CATNAME + " =  '" + category + "'", null); //cursor contain collection of data for particula query
        while (c.moveToNext()) {
            SubCategory subcat = new SubCategory(c.getInt(0),c.getString(2),c.getString(3)); //get the name of category and sub categoryand id
